...
class KNN_Classifier:
    ...
    def train(self):
        #TODO: train KNN model check SVM and modeltrainer for I/O datatypes and uses
        #return model
        pass

    def test(self):
        #TODO: test KNN modeL check SVM and modeltrainer for I/O datatypes and uses
        #       return accuracy, confusion matrix, classification report
        pass

    def cross_validation(self):
        # TODO: cross validation for KNN model check SVM and modeltrainer for I/O datatypes and uses
        #       return accuracy, std
        pass
